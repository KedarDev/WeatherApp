...
const Header = (props) => {
    ...
    const logout = () => {
        //this calls the logout function which removes the user data from the cookies
        appContext.logout();
    };
            ...
            <nav className="flex items-center justify-between flex-wrap bg-white/30 p-6 border-b border-indigo-700 shadow-lg">
                ...
                >
                    ...
                    <div className="text-sm lg:flex-grow">
                        <Link
                            className="block mt-4 lg:inline-block lg:mt-0 font-bold text-gray-300 hover:text-black  text-lg py-2 px-4 lg:-ml-2"
                    ...
                    <div>
                        <Link to="/login">
                            <div
                                className="inline-block no-underline text-gray-300  hover:text-black  font-bold text-lg py-2 px-4 rounded"
                                onClick={() => logout()}
                            >
                                Logout
                            </div>
