...
const Signup = () => {
  ...
  // handel toggle for Eye icon(password)
  const toggle = () => {
    setOpen(!open);
  };

  // yep validations for all fields in the sign up page
    ...
    >
      <div className="flex flex-col items-center min-h-screen pt-6 sm:justify-center sm:pt-0 b">
        <div>
          ...
          />
          <h3 className="text-4xl font-bold text-purple-800 text-gray-300">Join us !</h3>
        </div>
        <div className="w-full px-6 py-4 mt-6 overflow-hidden bg-white shadow-md sm:max-w-lg sm:rounded-lg">
          ...
          <div className="mt-4 text-grey-600">
            ...
            <span>
              <Link to="/login" className="text-purple-600 text-grey-400 hover:underline">
                Log in
              </Link>
            </span>
          </div>
