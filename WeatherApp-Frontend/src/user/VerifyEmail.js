...
//This functional component uses useParams hook to get the verification code and useNavigate hook to redirect the user to the respective routes
const VerifyEmail = () => {
    const { verificationCode } = useParams();
    let navigate = useNavigate();

    //This function will log the values and display a toast message indicating that the email verification code is present
    ...
    //This is for the verification code input field
