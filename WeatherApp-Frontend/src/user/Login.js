...
const Login = () => {
    ...
    //useNavigate hook which helps us to re-direct to the respective route
    ...
    //Define the toggle function to update the open state value (for eye icon)
    const toggle = () => {
        setOpen(!open);
    };

    //Define LoginSchema object using Yup to set up the validation rules for the username and password fields
        ...
        >
            <div className="flex flex-col items-center min-h-screen pt-6 sm:justify-center sm:pt-0 b">
                <div>
                    ...
                    />
                    <h3 className="text-4xl text-gray-300 font-bold text-center">
