...
import com.bptn.weatherapp.domain.HttpResponse;
...
import com.bptn.weatherapp.exception.domain.EmailNotFoundException;
...
public class ExceptionHandling implements ErrorController {
	...
	private String maskApiId(String str) {   	
	    return str.replaceAll("appid=.*&?","appid=****");
	}
	...
	public ResponseEntity<HttpResponse> cityNotFoundException(CityNotFoundException ex) {
		return this.createHttpResponse(BAD_REQUEST, ex.getMessage());
	}
	
	@ExceptionHandler(WebClientResponseException.class)
	public ResponseEntity<HttpResponse> webClientResponseException(WebClientResponseException ex) {
		return this.createHttpResponse(BAD_REQUEST, this.maskApiId(ex.getMessage()));
	}
